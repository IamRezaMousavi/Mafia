...
fun EditText.textAnimSwing(
    ...
    enterAnimationSwing(
        ...
        startPosition,
        duration
    ) // first play enter animation. End and Start positions are inverted for proper animation
    //exit
    Handler(Looper.getMainLooper()).postDelayed(
        {
...
fun EditText.textAnimSlideInLTR(
    translation: String,
    startPosition: Float,
    endPosition: Float,
    text: String,
...
fun EditText.textAnimSlideInRTL(
    translation: String,
    startPosition: Float,
    endPosition: Float,
    text: String,
