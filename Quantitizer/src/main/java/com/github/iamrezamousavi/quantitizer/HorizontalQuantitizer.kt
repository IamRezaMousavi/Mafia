...
import com.github.iamrezamousavi.quantitizer.databinding.HorizontalQuantitizerBinding


@SuppressLint("CustomViewStyleable")
class HorizontalQuantitizer @JvmOverloads constructor(
    context: Context,
    ...
    private val binding =
        HorizontalQuantitizerBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    fun setPlusIconBackgroundColor(colorString: String) {
        binding.increaseIb.backgroundTintList =
    ...
    fun setMinusIconBackgroundColor(colorString: String) {
        binding.decreaseIb.backgroundTintList =
            ColorStateList.valueOf(Color.parseColor(colorString))
    }
    ...
    fun setPlusBackground(@DrawableRes icon: Int) {
        binding.increaseIb.setBackgroundResource(icon)
    }
    ...
    fun setMinusBackground(@DrawableRes icon: Int) {
        binding.decreaseIb.setBackgroundResource(icon)
    }
